...
//console.log('[ClientUserNotificationsTemplate.js]: This code just ran.');
...
// Import template UI
import './ClientUserNotificationsTemplate.html';
...
Template.clientUserNotifications.onCreated(function () {
...
Template.clientUserNotifications.onDestroyed(function () {
});

Template.clientUserNotifications.events({
...
Template.clientUserNotifications.helpers({
    userNotifications() {
