/**
 * Created by Claudio on 2019-08-07.
 */

//console.log('[ApiMessageContainer2.js]: This code just ran.');
...
//    }
//  }
export function retrieveMessageContainer2() {
    try {
        ...
        try {
            containerInfo = this.user.device.retrieveMessageContainer2(this.urlParams.messageId);
        }
        catch (err) {
            let error;
