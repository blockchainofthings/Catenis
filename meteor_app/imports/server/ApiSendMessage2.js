...
export function sendMessage2() {
    try {
        ...
        try {
            messageId = this.user.device.sendMessage(targetDeviceId, msg, optReadConfirmation, optEncrypt, optStorage);
        }
        catch (err) {
            let error;
