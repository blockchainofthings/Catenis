...
//console.log('[ClientForeignBlockchainDetailsTemplate.js]: This code just ran.');
...
// Import template UI
import './ClientForeignBlockchainDetailsTemplate.html';
import { ReactiveDict } from 'meteor/reactive-dict';

// Import dependent templates
import '../adminUI/AddressQRCodeTemplate';
...
Template.clientForeignBlockchainDetails.onCreated(function () {
    ...
    this.currClntForeignBlockchainRecordSubs = this.subscribe('currentClientForeignBlockchainRecord', this.data.blockchainKey);
    this.currClntForeignBcConsumptionProfilesSubs = this.subscribe('currentClientForeignBcConsumptionProfiles');
});

Template.clientForeignBlockchainDetails.onDestroyed(function () {
    if (this.currClntForeignBlockchainRecordSubs) {
        this.currClntForeignBlockchainRecordSubs.stop();
    }

    if (this.currClntForeignBcConsumptionProfilesSubs) {
        this.currClntForeignBcConsumptionProfilesSubs.stop();
    }
});

Template.clientForeignBlockchainDetails.events({
    ...
    'change #selConsumptionProfile'(event, template) {
        ...
        Meteor.call(
            'updateCurrentClientForeignBcConsumptionProfile',
...
Template.clientForeignBlockchainDetails.helpers({
    blockchain() {
