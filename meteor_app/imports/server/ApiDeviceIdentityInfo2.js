...
//console.log('[ApiDeviceIdentityInfo2.js]: This code just ran.');
...
//      "name": [String]         - (only returned if not empty) Assigned name of Catenis node
...
//    }
//  }
export function retrieveDeviceIdentifyInfo2() {
    try {
        ...
        if (!(typeof this.queryParams.isProdUniqueId === 'undefined' || (typeof this.queryParams.isProdUniqueId === 'string' && isValidBooleanStr(this.queryParams.isProdUniqueId)))) {
            ...
            invalidParams.push('isProdUniqueId');
        }
