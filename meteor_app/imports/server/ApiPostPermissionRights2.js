...
//console.log('[ApiPostPermissionRights2.js]: This code just ran.');
...
//    "success": true
//  }
export function setPermissionRights2() {
    try {
        ...
        if (this.bodyParams.catenisNode !== undefined && !isValidRightSettingEntry(this.bodyParams.catenisNode)) {
            ...
            invalidParams.push('catenisNode');
        }
