...
//console.log('[ApiLogMessage4.js]: This code just ran.');
        ...
        if (!invalidMessage && messageData) {
            ...
            try {
                ...
                if (err.name === 'TypeError') {
                    Catenis.logger.DEBUG(`Incompatible encoding for \'${messageParam}\' parameter of \'messages/log\' API request`, this.bodyParams);
